...
casper.then(function(){
  this.wait(3000, function() {
    ...
    this.evaluate(function(){
      document.querySelector('#inputfrm > div.co-mainarea.co-editarea > table > tbody > tr.sch-row-date.normal > td > div > span:nth-child(5) > input').setAttribute('value','2300');
      document.querySelector('#inputfrm > div.co-mainarea.co-editarea > table > tbody > tr.sch-row-date.normal > td > div > span:nth-child(9) > input').setAttribute('value','2330');
    });
